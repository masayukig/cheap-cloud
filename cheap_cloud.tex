...
\place{\href{https://events.opensuse.org/conference/summitasia18}{@openSUSE.Asia Summit 2018}}

\title[private-cloud-on-openSUSE
  \hspace{2em}\insertframenumber/\inserttotalframenumber]{Building
...
\begin{frame}
  ...
  \begin{itemize}
    \item Replace the broken HDD to SSD (Done)
    \item Upgrade openSUSE to Leap 15.0 (WIP)
    \item Use a RaspberryPi3 model B+ as a controller node
